...
for speed in recorded_speeds:
    ...
    if speed > SPEED_LIMIT:
        print("WARNING - Vehicle recorded at", speed,
              "km/h. Exceeded limit of", SPEED_LIMIT, "km/h.")
...
print("Percentage speeding:", round(percentage_speeding, 2), "%")
print("Average speed:", round(average_speed, 2), "km/h")
